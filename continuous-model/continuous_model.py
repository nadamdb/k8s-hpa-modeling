...
class MMc_WeightedBusyTimeAnalyzer(object):
    ...
    def func_delta_der0(self, k, s, current_n1=None, current_n2=None):
        ...
        if k == 1:
            ...
            if current_n2 == 0:
                ...
                if current_n1 == 0:
                    ...
                    # 1 transition.
                    possible_solutions_prev_rec = self.func_delta_der0(2, s, 0, current_n2 - 1)
                    for delta_value in possible_solutions_prev_rec:
                    ...
                    possible_solutions_prev_rec_1_2 = self.func_delta_der0(2, s, current_n1, current_n2 - 1)
                    # so we decrease the desired number of 0 --> 1 transitions.
                    possible_solutions_prev_rec_0_1 = self.func_delta_der0(1, s, current_n1 - 1, current_n2)
        ...
        if k == self.c:
            ...
            possible_solutions_prev_rec = self.func_delta_der0(self.c - 1, s, current_n1, current_n2)
            ...
            # else: 1 < k < c
            possible_solutions_arr = self.func_delta_der0(k + 1, s, current_n1, current_n2)
            possible_solutions_dep = self.func_delta_der0(k - 1, s, current_n1, current_n2)
...
if __name__ == '__main__':
    analyzer = MMc_WeightedBusyTimeAnalyzer(lambda_=2, mu_=11, c=2)
    print analyzer.func_delta_der0(k=2, s=0)