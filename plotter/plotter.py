...
def plot_data(k8s_log=None, model_log=None, cont_model_pod_count=None, to_file_name=None):
    fig, ax = plt.subplots()
...
if __name__ == '__main__':
    ...
    plot_data(k8s_log, disc_model_log, cont_model_pod_count, to_file_name=args.file_name)
